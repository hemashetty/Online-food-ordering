...
{
    public partial class forget_pswd : System.Web.UI.Page
    {
        ...
        protected void btn_frgt_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(CS))
            {
                ...
                while (rdr.Read())
                {
                    ...
                    {
                        SendPasswordResetEmail(rdr["C_user"].ToString(), txt_email.Text, rdr["UniqueId"].ToString());
        ...
        private void SendPasswordResetEmail(string UserName, string ToEmail, string UniqueId)
        {
            ...
            sbEmailBody.Append("<br/>"); sbEmailBody.Append("http://localhost:51790/Pages/Resetpassword.aspx?uid=" + UniqueId);
